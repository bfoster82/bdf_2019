...
profile_smart = smart_data_test.profile_report(title="Smartcard Data Profile Report")
profile_journey = journey_data_test.profile_report(title="Journey Data Profile Report")

profile_smart.to_file(output_file="SmartCardDataProfile.html")
profile_journey.to_file(output_file="JourneyDataProfile.html")
